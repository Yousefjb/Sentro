...
{
    /*        
        TODO: Delete Verbal Expressions at the end of project if not used
    */
    public class VerbalExpressions
    {
        ...
        public VerbalExpressions OneOrMore()
        {           
            return Add("+");
        }

        public VerbalExpressions ZeroOrMore()
        {
            return Add("*");
        }
        ...
        public VerbalExpressions BeginNoneCapture()
        {
            return Add("(?:", false);
        }
        ...
        public VerbalExpressions EndNoneCapture()
        {
            return Add(")", false);
        }
